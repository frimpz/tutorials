...
data, _ = make_moons(10000, noise=0.1, random_state=0)

plt.scatter(*data.T)
plt.title("Moon dataset with noise {}".format(0.1))
plt.savefig("images/moon_noise.png")
...
fig.savefig("images/moon_noise_units_only.png")
fig2.savefig("images/moon_noise_edges.png")
plt.show()
